...
class TestPythonFunctionPractice(unittest.TestCase):
  ...
  def test_volume_of_cube(self):
    #add test code here
    side_of_cube_cubed = volume_of_cube(3)
    self.assertEqual(27,side_of_cube_cubed)
  ...
  def test_reverse_string(self):
    #add test code here
    backwards_string = reverse_string('CodeClan')
    self.assertEqual('nalCedoC',backwards_string)
